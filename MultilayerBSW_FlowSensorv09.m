...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 %Incident angle between normal and incident light
  incangle=linspace(64.5,66,4);
  eta_subtrate1=linspace(1.31,1.39,4);
%incangle=29.8;
  %Operating Wavelength
 lambda=linspace(635,635,1);
...
% axis tight;
   ...
   figure(4);
plot(incangle(1:end-2),sens(1:end-1),'LineWidth',2,'MarkerSize',7)
