...
rcwa.AddLayer('lYt',d_TiO2,'index',eta_Tio2);
 ...
 rcwa.AddLayer('lYt',d_TiO2,'index',eta_Tio2);
 rcwa.AddLayer('lYt',d_SiO2,'index',eta_SiO2);
 rcwa.AddLayer('lYt',d_TiO2,'index',eta_Tio2);% Extra TiO2
...
% Reflection and transmission coefficients
 ...
 save REFS632.txt refln -ascii
 REFS625=load ("REFS632.txt");
%  REFS632=load ("REFS632.txt");
%  REFS640=load ("REFS640.txt");
...
legend('632 nm ')
%   plot(incangle,REFS625,'r-',incangle,REFS632,'b',incangle,REFS640,'k','LineWidth',3,'MarkerSize',3)
%  legend('625 nm','632 nm ','640 nm ')
 xlabel('\theta (deg)')
 ylabel('Reflectivity.');
