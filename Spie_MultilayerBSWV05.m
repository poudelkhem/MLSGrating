...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 %Incident angle between normal and incident light
  incangle=linspace(60,63.2,5000);
...
%  legend('R.I.= 1.30','R.I.= 1.32 ','R.I.= 1.34')
  plot(incangle,REFS680,'r-',incangle,REFS690,'b',incangle,REFS700,'k','LineWidth',3,'MarkerSize',3)
 legend('680 nm','690 nm ','700 nm ')
 xlabel('\theta (deg)')
 ylabel('Reflectivity.');
