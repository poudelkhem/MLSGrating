...
%  legend('R.I.= 1.30','R.I.= 1.32 ','R.I.= 1.34')
   plot(incangle,REFS700,'r-',incangle,REFS710,'b',incangle,REFS720,'k','LineWidth',3,'MarkerSize',3)
 legend('700 nm','710 nm ','720 nm ')
 xlabel('\theta (deg)')
 ylabel('Reflectivity.');
