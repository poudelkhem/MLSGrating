...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 %Incident angle between normal and incident light
  incangle=linspace(65.2,65.8,1000);
...
% Reflection and transmission coefficients
  ...
  save REFSk2e5.txt refln -ascii
   REFS625=load ("REFSk1e6.txt");
   REFS635=load ("REFSk2e5.txt");
   REFS650=load ("REFSk5e5.txt");
...
%  legend('R.I.= 1.30','R.I.= 1.32 ','R.I.= 1.34')
  plot(incangle,REFS625,'r-',incangle,REFS635,'b',incangle,REFS650,'k','LineWidth',3,'MarkerSize',3)
 legend('K=1e-06','K=2e-05 ','K=5e-05 ')
 xlabel('\theta (deg)')
 ylabel('Reflectivity.');
