...
%   plot(incangle,REFS635,'r-',incangle,REFS650,'b',incangle,REFS665,'k','LineWidth',3,'MarkerSize',3)
 legend('635 nm','650 nm ','665 nm ')
 xlabel('\theta (deg)')
 ylabel('Reflectivity.');
