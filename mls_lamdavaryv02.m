%%********  3D RCWA implementation *************************************

% @ Khem N poudel MTSU , Date 05/10/2017


%Implement the 3D RCWA

%Referenc:R. C. Rumpf, Improved formulation of scattering matrices for semi-analytical methods that is consistent with
%convention," Progress In Electromagnetics Research B, 35, 241  261 (2011)
% M. G. Moharam, E. B. Grann,T. K. Gaylord, and D. A. Pommet, Formulation for stable and efficient implementation
%of the rigorous coupled-wave analysis of binary gratings," J. Opt. Soc. Am. A, 12, 1068  1076 (1995).
%V.Koju ,  Computational modelling of bloch surface waves in one dimensional periodic and aperiodic multilayer
%structure ," PHD thesis, Middle Tennessee State University (2017).
%%*********************************************************************
...
wavelength=linspace(400,800,50);

% the wavelength of the light in the air
incidentangle=linspace(8,50,1000);
