% *****************   MLS BSW  Design*********************
%@ Khem N poudel, Date 09/16/2018,MTSU
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 %Incident angle between normal and incident light
  incangle=linspace(10,90,1000);
  eta_subtrate1=linspace(1.31,1.36,5);
%incangle=29.8;
...
%     axis tight;
 % figure(1);
figure(3);
plot(eta_subtrate1,angval,'r-o','LineWidth',2,'MarkerSize',7)
% legend('R.I. 1.34000 ')
%   plot(incangle,REFS625,'r:',incangle,REFS635,'b--',incangle,REFS650,'k:','LineWidth',3,'MarkerSize',3)
%  legend('R.I.= 1.30','R.I.= 1.32 ','R.I.= 1.34')
%   plot(incangle,REFS625,'r-',incangle,REFS635,'b',incangle,REFS650,'k','LineWidth',3,'MarkerSize',3)
